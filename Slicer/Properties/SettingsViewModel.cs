...
namespace Slicer.Properties
{
    ...
    using Slicer.Engine.Scanning;
    using Slicer.Engine.Scanning.Properties;
    using Slicer.Source.Docking;
    using System;
    ...
    public class SettingsViewModel : ToolViewModel
    {
        ...
        public String ProjectRoot
        {
            get
            {
                ...
                {
                    savedPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments), "Slicer");
