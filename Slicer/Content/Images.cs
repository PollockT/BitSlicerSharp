using Slicer.Source.Utils;

namespace Slicer.Content
{
    using Slicer.Source.Utils;
    using System;
    using System.IO;
    ...
    public class Images
    {
        ...
        /// Image for Slicer.
        /// </summary>
        public static readonly BitmapImage Squalr = Images.LoadImage("Slicer.png");

        /// <summary>
        /// Image for Slicer Dev.
        /// </summary>
        ...
        /// </summary>
        private const String ImageBasePath = "pack://application:,,,/Slicer;component/Content/Images/";
