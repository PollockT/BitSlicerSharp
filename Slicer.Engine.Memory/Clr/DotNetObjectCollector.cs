namespace Slicer.Engine.Memory.Clr
{
    ...
    public class DotNetObjectCollector
    {
        ...
        protected void OnUpdate(CancellationToken cancellationToken)
        {
            ...
            IProxyService proxyService = proxyCommunicator.GetProxyService(Slicer.Engine.Engine.GetInstance().Processes.IsOpenedProcess32Bit());
